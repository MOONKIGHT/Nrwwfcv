...
global.repox = 'MOONKIGHT/Nrwwfcv'
global.branx = 'master'
...
if (stickerpack.spackname == '') {
  var sticker_name = 'IMASH'
  var sticker_author = '⃧ᴍ⃥⃧͢🌑⃥⃭⃧🌕̶̷⃮⃧ɴ ⃥ᴋ⃯⃗ɴ⃧ɪ⃬⃗ɢ⃧ʜ⃯⃗ᴛ ʙ⃔⃧ᴏ⃕⃧ᴛ⃕-ᴢ⃕🌙'
 } else {
...
if (ctickerpack.cpackname == '') {
  var colong_name = 'TEST NOW1'
  var colong_author = 'TEST NOW2'
 } else {
...
global.wm = 'TEST NOW WM'
global.ucpn = ''

//================= Url =================//
global.linkgc = 'https://chat.whatsapp.com/LebNBnyIOCR7vsTfeLutz7'
global.linkig = 'https://youtu.be/InUJUVAD7bA'
global.linkyt = 'https://youtu.be/InUJUVAD7bA'
global.linkfb = 'https://www.facebook.com/nidusha.fernando'
global.web = 'https://chat.whatsapp.com/LebNBnyIOCR7vsTfeLutz7'
global.web1 = 'https://chat.whatsapp.com/LebNBnyIOCR7vsTfeLutz7'

global.deslink = ''
global.titlink = 'Folllow me on facebook'
global.bodlink = '©MOON KNIGHT BOT~Z'

//========= Url Template Button =========//
global.dtu = 'Group WhatsApp'
global.urlnya = 'https://chat.whatsapp.com/LebNBnyIOCR7vsTfeLutz7'

//========= Call Template Button =========//
global.dtc = 'Add Me'
global.nmbrnya = '+94771323434'
